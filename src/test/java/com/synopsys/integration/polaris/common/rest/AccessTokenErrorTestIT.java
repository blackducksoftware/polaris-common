...
public class AccessTokenErrorTestIT {
    ...
    public void unauthorizedTest() throws IntegrationException, IOException {
        AccessTokenPolarisHttpClient httpClient = new AccessTokenPolarisHttpClient(new PrintStreamIntLogger(System.out, LogLevel.INFO), 300, true, ProxyInfo.NO_PROXY_INFO, new HttpUrl("http://www.blackducksoftware.com"), "garbage token", new Gson(), new UrlSupport(), new AuthenticationSupport(new UrlSupport()));
